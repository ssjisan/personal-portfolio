            ...
            <div className="card" style={{width: "18rem"}}>
                <Card className={classes.root} >
                    ...
                    <CardActions disableSpacing>
                        ...
                        <Button variant="contained" style={{backgroundColor:'red'}}  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCreativeAgency"> More </Button>
                            <div class="modal fade" id="exampleModalCreativeAgency" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br/>
                                    <a href="https://github.com/ssjisan/creative-agency"><Button variant="contained" color="secondary"> Github </Button></a>
                                </div>
            ...
            <div className="card" style={{width: "18rem"}}>
                <Card className={classes.root}>
                    ...
                    <CardActions disableSpacing>
                        ...
                        <Button variant="contained" style={{backgroundColor:'red'}}  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalVolunteerNetwrok"> More </Button>
                            <div class="modal fade" id="exampleModalVolunteerNetwrok" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-body" id="ca">
                                    ...
                                    <h5 style={{color: 'red'}}>For more details please visit my github repository</h5>
                                    <br/>
                                    <a href="https://github.com/ssjisan/volunteer-netwrok-site"><Button variant="contained" color="secondary"> Github </Button> </a>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
            ...
            <div className="card" style={{width: "18rem"}}>
                <Card className={classes.root}>
                    ...
                    <CardActions disableSpacing>
                            ...
                            <Button variant="contained" style={{backgroundColor:'red'}}  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalWeatherApp"> More </Button>
